...
window.addEventListener("DOMContentLoaded" , function () {
    ...
    switch (DATE.getUTCMonth() + 1) {
        ...
        case 2:
            tab.content = '#a0c4ff';
            bg.className = 'winter';
            icon.setAttribute("href" , '../Pic/Tab/winter.png' );
        ...
        case 5:
            tab.content = '#a1ff0a';
            bg.className = 'spring';
            icon.setAttribute("href" , '../Pic/Tab/spring.png' );
            break;
        case 6:
        case 7:
        case 8:
            tab.content = '#ef0';
            bg.className = 'summer';
            icon.setAttribute("href" , '../Pic/Tab/summer.png' );
            break;
        case 9:
        case 10:
        case 11:
            tab.content = '#ff8700';
            bg.className = 'autumn';
            icon.setAttribute("href" , '../Pic/Tab/autumn.png' );
